...
public class Constant {
    ...
    public static final String TESTSOFTWARE = "C:\\catchfile\\version\\Lazada收集助手试用版V1.0.exe";//测试版
    public static final String FORMATSOFTWARE = "C:\\catchfile\\version\\Lazada收集助手正式版V1.0.exe";//正式版
